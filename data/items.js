...
let BattleItems = {
	...
	"babiriberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Steel' && this.activeMoveHit.typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
	...
	"chartiberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Rock' && this.activeMoveHit.typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"chopleberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Fighting' && this.activeMoveHit.typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"cobaberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Flying' && this.activeMoveHit.typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"colburberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Dark' && this.activeMoveHit.typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"enigmaberry": {
		...
		onHit(target, source, move) {
			if (move && this.activeMoveHit.typeMod > 0) {
				if (target.eatItem()) {
	...
	"habanberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Dragon' && this.activeMoveHit.typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"kasibberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Ghost' && this.activeMoveHit.typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"kebiaberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Poison' && this.activeMoveHit.typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"occaberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Fire' && this.activeMoveHit.typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"passhoberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Water' && this.activeMoveHit.typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"payapaberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Psychic' && this.activeMoveHit.typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"rindoberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Grass' && this.activeMoveHit.typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"roseliberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Fairy' && this.activeMoveHit.typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"shucaberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Ground' && this.activeMoveHit.typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"tangaberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Bug' && this.activeMoveHit.typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"wacanberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Electric' && this.activeMoveHit.typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"weaknesspolicy": {
		...
		onHitPriority: 1,
		onHit(target, source, move) {
			if (target.hp && move.category !== 'Status' && !move.damage && !move.damageCallback && this.activeMoveHit.typeMod > 0 && target.useItem()) {
	...
	"yacheberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Ice' && this.activeMoveHit.typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
