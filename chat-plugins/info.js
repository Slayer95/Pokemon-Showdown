...
var commands = exports.commands = {
	...
	dice: function (target, room, user) {
		...
		if (diceDataStart >= 0) {
			...
			if (!Number.isInteger(diceQuantity) || diceQuantity <= 0 || diceQuantity > maxDice) return this.sendReply("The amount of dice rolled should be a natural number up to " + maxSize + ".");
		}
		var offset = 0;
		var removeOutlier = 0;
		...
		var trackRolls = diceQuantity * ('' + diceFaces).length <= 50;
		var rolls = [];
		var rollSum = 0;
	...
	dicehelp: ["/dice [max number] - Randomly picks a number between 1 and the number you choose.",
		...
		"/dice [number of dice]d[number of sides][+/-][offset] - Simulates rolling a number of dice and adding an offset to the sum, e.g., /dice 2d6+10: two standard dice are rolled, and returns a value between 12 and 22.",
		"/dice [number of dice]d[number of sides]-[H/L] - Simulates rolling a number of dice with removal of extreme values, e.g., /dice 3d8-L: three 8-sided dice and ignoring the lowest value."],
